...
fun EditNoteScreen(
    ...
    noteId: Int,
    onBackClick: () -> Unit,
    viewModelFactory: EditNoteViewModelFactory = (androidx.compose.ui.platform.LocalContext.current.applicationContext as NoteKeeperApp).container.getEditNoteViewModelFactory(),
    viewModel: EditNoteViewModel = viewModel(factory = viewModelFactory)
) {
